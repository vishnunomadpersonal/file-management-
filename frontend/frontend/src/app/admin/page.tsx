    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Monitor and manage all organizations, users, and system health</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          ...
          <h3 className="text-3xl font-bold text-white">{platformStats.organizations.total.toLocaleString()}</h3>
          <p className="text-gray-400 text-sm mt-1">Total Organizations</p>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          ...
          <h3 className="text-3xl font-bold text-white">{platformStats.users.total.toLocaleString()}</h3>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          ...
          <h3 className="text-3xl font-bold text-white">{platformStats.files.total.toLocaleString()}</h3>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-red-500/30">
          ...
          <h3 className="text-3xl font-bold text-white">{platformStats.threats.quarantined}</h3>
          <p className="text-gray-400 text-sm mt-1">Threats Quarantined</p>
          <div className="mt-4 flex items-center gap-2">
            <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded-full">
              100% detected
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-white">Platform Storage</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div className="text-center p-3 bg-gray-700/50 rounded-lg">
                ...
                <p className="text-xs text-gray-400">TB Used</p>
              </div>
              <div className="text-center p-3 bg-gray-700/50 rounded-lg">
                <p className="text-2xl font-bold text-white">5.8</p>
                <p className="text-xs text-gray-400">TB Available</p>
              </div>
              <div className="text-center p-3 bg-gray-700/50 rounded-lg">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-4 bg-gray-700/50 rounded-xl">
              <p className="text-3xl font-bold text-white">1.28M</p>
              <p className="text-xs text-gray-400 mt-1">Requests Today</p>
            </div>
            <div className="text-center p-4 bg-gray-700/50 rounded-xl">
          ...
          <p className="text-xs text-gray-500 text-center mt-2">Last 12 hours</p>
        </div>
      </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 lg:col-span-2">
          ...
          <div className="space-y-4">
            {recentActivities.map((activity, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-4 p-3 bg-gray-700/30 rounded-lg">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-white">Top Organizations by Usage</h3>
            ...
            <tbody className="divide-y divide-gray-700/50">
              {topOrganizations.map((org, i) => (
                <tr key={i} className="hover:bg-gray-700/30">
                  ...
                  <td className="py-4 text-white">{org.files.toLocaleString()}</td>
                  <td className="py-4 text-white">{formatBytes(org.storage)}</td>
                  <td className="py-4">
